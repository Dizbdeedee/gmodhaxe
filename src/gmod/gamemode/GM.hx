...
extern class GM {
    ...
    **/
    ...
    @:hook
    function IsSpawnpointSuitable(ply:Player, spawnpoint:Entity, makeSuitable:Bool):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function ShouldCollide(ent1:Entity, ent2:Entity):Bool;
    ...
    **/
    ...
    @:hook
    function PlayerCanPickupItem(ply:Player, item:Entity):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function StartChat(isTeamChat:Bool):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function OnPlayerChat(ply:Player, text:String, teamChat:Bool, isDead:Bool):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function AllowPlayerPickup(ply:Player, ent:Entity):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function ScalePlayerDamage(ply:Player, hitgroup:HITGROUP, dmginfo:CTakeDamageInfo):Bool;
    ...
    **/
    ...
    @:hook
    function PreDrawOpaqueRenderables(isDrawingDepth:Bool, isDrawSkybox:Bool):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function OnPhysgunFreeze(weapon:Entity, physobj:PhysObj, ent:Entity, ply:Player):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function VGUIMousePressAllowed(button:MOUSE):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function InputMouseApply(cmd:CUserCmd, x:Float, y:Float, ang:Angle):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function HandlePlayerVaulting(ply:Player, velocity:Float):Bool;
    ...
    **/
    ...
    @:hook
    function PlayerCanSeePlayersChat(text:String, teamOnly:Bool, listener:Player, speaker:Player):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function PlayerDeathThink(ply:Player):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function EntityKeyValue(ent:Entity, key:String, value:String):String;
    ...
    **/
    ...
    @:hook
    function PreDrawViewModel(vm:Entity, ply:Player, weapon:Weapon):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function HandlePlayerLanding(ply:Player, velocity:Float, onGround:Bool):Bool;
    ...
    **/
    ...
    @:hook
    function PlayerCanPickupWeapon(ply:Player, wep:Weapon):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function FinishMove(ply:Player, mv:CMoveData):Bool;
    ...
    **/
    ...
    @:hook
    function CanPlayerSuicide(player:Player):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function PlayerCanHearPlayersVoice(listener:Player, talker:Player):GmPlayerCanHearPlayersVoiceReturn; //return
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function HandlePlayerDriving(ply:Player):Bool;
    ...
    **/
    ...
    @:hook
    function PlayerSay(sender:Player, text:String, teamChat:Bool):String;
    #end
    ...
    **/
    ...
    @:hook
    function PlayerNoClip(ply:Player, desiredState:Bool):Bool;
    ...
    **/
    ...
    @:hook
    function ShouldDrawLocalPlayer(ply:Player):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function PlayerSelectTeamSpawn(team:Float, ply:Player):Entity;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function HUDShouldDraw(name:HUDElementList):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function DoAnimationEvent(ply:Player, event:PLAYERANIMEVENT, ?data:ACT):ACT;
    ...
    **/
    ...
    @:hook
    function RenderScene(origin:Vector, angles:Angle, fov:Float):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function PlayerSwitchFlashlight(ply:Player, enabled:Bool):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function GetTeamNumColor(team:Float):AnyTable;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function PlayerSpray(sprayer:Player):Bool;
    #end
    ...
    **/
	...
	@:hook
	#if server
    function PlayerFootstep(ply:Player, pos:Vector, foot:Float, sound:String, volume:Float, filter:CRecipientFilter):Bool;
	#else
	function PlayerFootstep(ply:Player, pos:Vector, foot:Float, sound:String, volume:Float):Bool;
	#end
    /**
    ...
    **/
    ...
    @:hook
    function GetPreferredCarryAngles(ent:Entity):Angle;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function CanPlayerUnfreeze(player:Player, entity:Entity, phys:PhysObj):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function CreateMove(cmd:CUserCmd):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function PlayerDeathSound():Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function HandlePlayerSwimming(ply:Player, velocity:Float):Bool;
    ...
    **/
    ...
    @:hook
    function CalcMainActivity(ply:Player, vel:Vector):GmCalcMainActivityReturn;
    ...
    **/
    ...
    @:hook
    function SetupSkyboxFog(scale:Float):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function GravGunPunt(ply:Player, ent:Entity):Bool;
    ...
    **/
    ...
    @:hook
    function GetFallDamage(ply:Player, speed:Float):Float;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function CanExitVehicle(veh:Vehicle, ply:Player):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function PlayerBindPress(ply:Player, bind:String, pressed:Bool):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function CalcVehicleView(veh:Vehicle, ply:Player, view:CamData):CamData;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function ChatText(index:Float, name:String, text:String, type:String):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function AcceptInput(ent:Entity, input:String, activator:Entity, caller:Entity, value:Dynamic):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function AdjustMouseSensitivity(defaultSensitivity:Float):Float;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function PreDrawPlayerHands(hands:Entity, vm:Entity, ply:Player, weapon:Weapon):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function PhysgunPickup(player:Player, entity:Entity):Bool;
    ...
    **/
    ...
    @:hook
    function OnPlayerHitGround(player:Entity, inWater:Bool, onFloater:Bool, speed:Float):Bool;
    ...
    **/
    ...
    @:hook
    function Move(ply:Player, mv:CMoveData):Bool;
    ...
    **/
    ...
    @:hook
    function PlayerCanJoinTeam(ply:Player, team:Float):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function PreDrawTranslucentRenderables(isDrawingDepth:Bool, isDrawSkybox:Bool):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function CheckPassword(steamID64:String, ipAddress:String, svPassword:String, clPassword:String, name:String):GmCheckPasswordReturn;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function CalcViewModelView(wep:Weapon, vm:Entity, oldPos:Vector, oldAng:Angle, pos:Vector, ang:Angle):GmCalcViewModelViewReturn;
    #end
    ...
    **/
    ...
    @:hook
    function CalcView(ply:Player, origin:Vector, angles:Angle, fov:Float, znear:Float, zfar:Float):CamData;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function TranslateActivity(ply:Player, act:ACT):Float;
    ...
    **/
    ...
    @:hook
    function PlayerShouldTaunt(ply:Player, act:ACT):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function PrePlayerDraw(player:Player):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function PostProcessPermitted(ppeffect:String):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function GravGunPickupAllowed(ply:Player, ent:Entity):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function CanEditVariable(ent:Entity, ply:Player, key:String, val:String, editor:AnyTable):Bool;
    #end
    ...
    **/
    ...
    @:hook
    function EntityFireBullets(ent:Entity, data:Bullet):Bool;
    ...
    **/
    ...
    @:hook
    function HandlePlayerJumping(ply:Player, velocity:Float):Bool;
    ...
    **/
    ...
    @:hook
    function EntityTakeDamage(target:Entity, dmg:CTakeDamageInfo):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function PlayerShouldTakeDamage(ply:Player, attacker:Entity):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function EntityEmitSound(data:EmitSoundInfo):Bool;
    ...
    **/
    ...
    @:hook
    function CanPlayerEnterVehicle(player:Player, vehicle:Vehicle, role:Float):Bool;
    #end
    #if server
    /**
    ...
    **/
    ...
    @:hook
    function DrawPhysgunBeam(ply:Player, physgun:Weapon, enabled:Bool, target:Entity, physBone:Float, hitPos:Vector):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function PlayerTraceAttack(ply:Player, dmginfo:CTakeDamageInfo, dir:Vector, trace:TraceResult):Bool;
    ...
    **/
    ...
    @:hook
    function ForceDermaSkin():String;
    #end
    ...
    **/
    ...
    @:hook
    function PlayerSelectSpawn(ply:Player, transition:Bool):Entity;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function OnChatTab(text:String):String;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function GetMotionBlurValues(horizontal:Float, vertical:Float, forward:Float, rotational:Float):GmGetMotionBlurValuesReturn;
    #end
    ...
    **/
    ...
    @:hook
    function PlayerUse(ply:Player, ent:Entity):Bool;
    #end
    #if client
    /**
    ...
    **/
    ...
    @:hook
    function HandlePlayerNoClipping(ply:Player, velocity:Float):Bool;
    ...
    **/
    ...
    @:hook
    function HandlePlayerDucking(ply:Player, velocity:Float):Bool;
    ...
    **/
    ...
    @:hook
    function GetTeamColor(ent:Entity):AnyTable;
    #end
    ...
    **/
    ...
    @:hook
    function PlayerStepSoundTime(ply:Player, type:STEPSOUNDTIME, walking:Bool):Float;
    ...
    **/
    ...
    @:hook
    function PreventScreenClicks():Bool;
    #end
    ...
    **/
    ...
    @:hook
    function PlayerSwitchWeapon(player:Player, oldWeapon:Weapon, newWeapon:Weapon):Bool;
    ...
    **/
    ...
    @:hook
    function OnPhysgunReload(physgun:Weapon, ply:Player):Bool;
    #end
    #if server
    /**
...
@:multiReturn extern class GmPlayerCanHearPlayersVoiceReturn {
    /**
       Return true if the listener should hear the talker
    **/
    var a:Bool;
    var b:Bool;
